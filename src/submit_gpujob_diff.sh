...
#-----------------------------------------------------------------------------
#
#SBATCH -J al_easy                           # Job name
#SBATCH -o job_outputs/difficulty/al_easy-%j.out                     # Name of stdout output file (%j expands to jobId)
