...
#-----------------------------------------------------------------------------
#
#SBATCH -J classes25                           # Job name
#SBATCH -o job_outputs/classes/classes25-%j.out                     # Name of stdout output file (%j expands to jobId)
